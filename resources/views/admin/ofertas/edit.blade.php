<x-admin>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-graduation-cap me-2"></i>Editar Oferta
            </h3>
        ...
        <form action="{{ route('admin.oferta.update', $data) }}" method="POST" class="needs-validation" novalidate>
            @method('PUT')
            @csrf
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="name" class="form-label">Nome da Oferta</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="coordenador" id="coordenador" class="form-control @error('coordenador') is-invalid @enderror" required>
                                ...
                                @foreach ($users as $user)
                                    <option {{ old('coordenador', $data->coordenador_id) == $user->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control @error('category') is-invalid @enderror" required>
                                ...
                                @foreach ($institution as $inst)
                                    <option {{ $data->institution_id == $inst->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="school" id="school" class="form-control @error('school') is-invalid @enderror">
                                ...
                                @foreach ($schools as $school)
                                    <option {{ $data->school_id == $school->id ? 'selected' : '' }}
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="turno" id="turno" class="form-control @error('turno') is-invalid @enderror" required>
                                ...
                                <option value="Matutino" {{ $data->turno == 'Matutino' ? 'selected' : '' }}>Matutino</option>
                                <option value="Vespertino" {{ $data->turno == 'Vespertino' ? 'selected' : '' }}>Vespertino</option>
                                <option value="Noturno" {{ $data->turno == 'Noturno' ? 'selected' : '' }}>Noturno</option>
                            </select>
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo_sistema_academico" id="codigo_sistema_academico" value="{{ old('codigo_sistema_academico', $data->codigo_sistema_academico) }}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="turma" id="turma" value="{{ old('turma', $data->turma) }}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome_curso" id="nome_curso" value="{{ old('nome_curso', $data->nome_curso) }}"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="ano_letivo" id="ano_letivo" class="form-control @error('ano_letivo') is-invalid @enderror" required>
                                ...
                                <option value="2024" {{ old('ano_letivo', $data->ano_letivo) == '2024' ? 'selected' : '' }}>2024</option>
                                <option value="2025" {{ old('ano_letivo', $data->ano_letivo) == '2025' ? 'selected' : '' }}>2025</option>
                                <option value="2026" {{ old('ano_letivo', $data->ano_letivo) == '2026' ? 'selected' : '' }}>2026</option>
                            </select>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="periodo_letivo" id="periodo_letivo" class="form-control @error('periodo_letivo') is-invalid @enderror" required>
                                ...
                                <option value="1º Semestre" {{ old('periodo_letivo', $data->periodo_letivo) == '1º Semestre' ? 'selected' : '' }}>1º Semestre</option>
                                <option value="2º Semestre" {{ old('periodo_letivo', $data->periodo_letivo) == '2º Semestre' ? 'selected' : '' }}>2º Semestre</option>
                                <option value="Anual" {{ old('periodo_letivo', $data->periodo_letivo) == 'Anual' ? 'selected' : '' }}>Anual</option>
                            </select>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="responsavel_transporte_estudante" id="responsavel_transporte_estudante" class="form-control @error('responsavel_transporte_estudante') is-invalid @enderror">
                                ...
                                <option value="Instituição" {{ old('responsavel_transporte_estudante', $data->responsavel_transporte_estudante) == 'Instituição' ? 'selected' : '' }}>Instituição</option>
                                <option value="Escola" {{ old('responsavel_transporte_estudante', $data->responsavel_transporte_estudante) == 'Escola' ? 'selected' : '' }}>Escola</option>
                                <option value="Não há disponibilização de transporte" {{ old('responsavel_transporte_estudante', $data->responsavel_transporte_estudante) == 'Não há disponibilização de transporte' ? 'selected' : '' }}>Não há disponibilização de transporte</option>
                            </select>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="oferta_auxilio_financeiro" id="oferta_auxilio_financeiro" class="form-control @error('oferta_auxilio_financeiro') is-invalid @enderror">
                                <option value="" selected disabled>Selecione a opção</option>
                                <option value="Sim" {{ old('oferta_auxilio_financeiro', $data->oferta_auxilio_financeiro) == 'Sim' ? 'selected' : '' }}>Sim</option>
                                <option value="Não" {{ old('oferta_auxilio_financeiro', $data->oferta_auxilio_financeiro) == 'Não' ? 'selected' : '' }}>Não</option>
                            </select>
