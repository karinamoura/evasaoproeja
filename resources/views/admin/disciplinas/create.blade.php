<x-admin>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-book me-2"></i>Cadastrar Disciplina
            </h3>
        ...
        <form action="{{ route('admin.disciplina.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="professor_id" id="professor_id" class="form-control @error('professor_id') is-invalid @enderror" required>
                                ...
                                @foreach ($professores as $professor)
                                    <option {{ old('professor_id') == $professor->id ? 'selected' : '' }}
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="carga_horaria_total" id="carga_horaria_total" value="{{ old('carga_horaria_total') }}"
