<x-admin>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-school me-2"></i>Cadastrar Nova Escola
            </h3>
        ...
        <form action="{{ route('admin.escola.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="institution"
                                ...
                                @foreach ($institution as $inst)
                                    <option value="{{ $inst->id }}" {{ old('institution') == $inst->id ? 'selected' : '' }}>
                                        {{ $inst->name }}
                                    </option>
                                @endforeach
                            </select>
