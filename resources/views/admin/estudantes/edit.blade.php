<x-admin>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-user-graduate me-2"></i>Editar Estudante
            </h3>
        ...
        <form action="{{ route('admin.estudante.update', encrypt($estudante->id)) }}" method="POST" class="needs-validation" novalidate>
            @method('PUT')
            @csrf
            <div class="card-body">
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="data_nascimento" id="data_nascimento" value="{{ old('data_nascimento', $estudante->data_nascimento ? $estudante->data_nascimento->format('Y-m-d') : '') }}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="matricula" id="matricula" value="{{ old('matricula', $estudante->matricula) }}"
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome_mae" id="nome_mae" value="{{ old('nome_mae', $estudante->nome_mae) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select name="oferta_id" id="oferta_id" class="form-control @error('oferta_id') is-invalid @enderror" required>
                                ...
                                @foreach ($ofertas as $oferta)
                                    <option {{ old('oferta_id', $estudante->oferta_id) == $oferta->id ? 'selected' : '' }}
                ...
                <div class="row mb-4">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="cep" id="cep" value="{{ old('cep', $estudante->cep) }}"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $estudante->telefone) }}"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $estudante->email) }}"
