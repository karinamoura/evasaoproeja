<x-admin>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-user-shield me-2"></i>Criar Novo Perfil
            </h3>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback">Nome do perfil é obrigatório</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="text-muted small mb-2">Selecione as permissões que este perfil terá em cada área do sistema.</p>
                                            ...
                                            <div class="card-body" style="max-height: 520px; overflow-y: auto;">
                                                ...
                                                @else
                                                    <div class="alert alert-info">
                                                        ...
                                                        Nenhuma permissão cadastrada. Execute: <code>php artisan db:seed --class=PermissionSeeder</code>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
