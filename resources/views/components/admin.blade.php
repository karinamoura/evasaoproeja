...
<body class="hold-transition sidebar-mini layout-fixed {{ Auth::check() && Auth::user()->mode ? Auth::user()->mode : 'light' }}-mode">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-{{ Auth::check() && Auth::user()->mode ? Auth::user()->mode : 'light' }}-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{ route('admin.dashboard') }}" class="brand-link text-center py-2 d-block text-decoration-none">
                <span class="brand-icon-letter">E</span>
                <span class="brand-text font-weight-light d-block small mt-1">{{ config('app.name') }}</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
                <!-- Sidebar Menu -->
    ...
    <script src="{{ asset('admin/plugins/summernote/lang/summernote-pt-BR.min.js') }}"></script>
    <!-- overlayScrollbars -->
