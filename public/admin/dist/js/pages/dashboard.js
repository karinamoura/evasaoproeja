...
$(function () {
  ...
  // Sparkline charts
  if ($('#sparkline-1').length > 0 && $('#sparkline-1')[0]) {
    var sparkline1 = new Sparkline($('#sparkline-1')[0], { width: 80, height: 50, lineColor: '#92c1dc', endColor: '#ebf4f9' })
    sparkline1.draw([1000, 1200, 920, 927, 931, 1027, 819, 930, 1021])
  }
  if ($('#sparkline-2').length > 0 && $('#sparkline-2')[0]) {
    var sparkline2 = new Sparkline($('#sparkline-2')[0], { width: 80, height: 50, lineColor: '#92c1dc', endColor: '#ebf4f9' })
    sparkline2.draw([515, 519, 520, 522, 652, 810, 370, 627, 319, 630, 921])
  }
  if ($('#sparkline-3').length > 0 && $('#sparkline-3')[0]) {
  ...
  if ($('#sales-chart-canvas').length > 0) {
    pieChartCanvas = $('#sales-chart-canvas').get(0).getContext('2d')
  }
  var pieData = {
    labels: [
      'Instore Sales',
  ...
  if ($('#line-chart').length > 0) {
    salesGraphChartCanvas = $('#line-chart').get(0).getContext('2d')
  }
  // $('#revenue-chart').get(0).getContext('2d');
